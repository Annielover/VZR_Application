...
namespace TweedeZit.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IMedewerkerRepository medewerkerRepository)
        {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError("", "De ingegeven naam of wachtwoord is niet correct!");
            return View(model);
        }
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    medewerkerRepository.SaveChanges();
