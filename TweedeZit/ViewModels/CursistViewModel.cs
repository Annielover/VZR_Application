...
namespace TweedeZit.ViewModels
{
    public class EditViewModel
    {
        ...
        public EditViewModel(IEnumerable<Leertraject> leertrajecten, IEnumerable<Cursist> cursisten,
            Medewerker medewerker)
        {
            Leertrajecten = new SelectList(leertrajecten, "LeertrajectId", "Titel",
                medewerker.GetLeertrajectFromCursist(cursisten.Select(c => c.CursistId).FirstOrDefault()).Titel);
