        ...
        protected override void Seed(AanwezigheidsContext context)
        {
            try
            {
                ...
                leertraject1.Add(new Cursist
                {
                    ...
                    Straat = "Teststraat",
                    Straatnummer = "123A",
                    Telefoon = "055/21.22.23",
                    Abonnement = abonnement,
                    Geboortedatum = geboren,
                    NaamMama = "Tania Dexters",
                    NaamPapa = "Elton John"
                });
                leertraject1.Add(new Cursist
                {
                ...
                leertraject8.Add(new Cursist
                {
                    Naam = "Mattelin",
                    Voornaam = "Marie-Aline",
                    Email = "test@hotmail.com",
                    Gemeente = "Ronse",
                    Postcode = 9600,
                    Straat = "Gustave Royerslaan",
                    Straatnummer = "73",
                    Telefoon = "055/21.26.73",
                    Abonnement = abonnement,
                    Geboortedatum = geboren,
                    NaamMama = "",
                    NaamPapa = ""
                ...
                var zwembad1 = new Zwembad
                {
                    Naam = "Zwembad Los Angeles",
                    Straat = "Colton Street",
                    Gemeente = "Los Angeles",
                    Postcode = 94102,
                    Straatnummer = "1445"
                };
                var zwembad2 = new Zwembad
                {
                    Naam = "Zwembad Pasadena",
                    Straat = "Foothill Blvd",
                    Gemeente = "Pasadena",
                    Postcode = 90001,
                    Straatnummer = "2290"
                };
                var zwembad3 = new Zwembad
                {
                    Naam = "Zwembad San Fransisco",
                    Straat = "19th Avenue",
                    Gemeente = "San Fransisco",
                    Postcode = 91101,
                    Straatnummer = "334"
                };
            ...
            catch (DbEntityValidationException e)
            {
                ...
                foreach (DbEntityValidationResult eve in e.EntityValidationErrors)
                {
                    ...
                    s = eve.ValidationErrors.Aggregate(s,
                        (current, ve) =>
                            current +
